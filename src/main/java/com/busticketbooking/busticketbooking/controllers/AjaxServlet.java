...
import com.busticketbooking.busticketbooking.models.Config;
 ...
 * @author CTT VNPAY
 */
@WebServlet(name = "ajaxServlet", value = "/vn-pay")
public class AjaxServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int amount = (int)Math.ceil(Double.parseDouble(price)) * 100;
        ...
        try {
            int bookingId = ConvertUtil.convert(req.getParameter("bookingId"));
            BookingDao bookingDao = new BookingDaoImpl();
            Booking booking = bookingDao.getById(bookingId);
            req.getSession().setAttribute("bookingPayment", booking);
